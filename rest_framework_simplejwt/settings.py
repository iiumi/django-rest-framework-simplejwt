...
DEFAULTS = {
    ...
    'USER_IS_SUPERUSER_FIELD': 'is_superuser',
    'USER_IS_SUPERUSER_CLAIM': 'is_superuser',
    'USER_USER_SELLER_FIELD': 'user_seller',
    'USER_USER_SELLER_CLAIM': 'user_seller',
    'USER_USER_AUTHOR_FIELD': 'user_author',
    'USER_USER_AUTHOR_CLAIM': 'user_author',
    'USER_IS_ACTIVE_FIELD': 'is_active',
    'USER_IS_ACTIVE_CLAIM': 'is_active',
    'USER_IS_STAFF_FIELD': 'is_staff',
    'USER_IS_STAFF_CLAIM': 'is_staff',
